...
async def run_test():
    ...
    try:
        ...
        # -> Fill the GitHub username with 'octocat' (ensure value), submit the form to generate the Wrapped view, then press ArrowRight and ArrowLeft to test that left arrow returns the carousel to the previous card.
